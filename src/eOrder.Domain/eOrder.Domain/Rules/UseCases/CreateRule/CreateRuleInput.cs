...
{
    public class CreateRuleInput : IRequest<RuleOutput>
    {
        public CreateRuleInput(string name, string description, string group, int code, int index, bool runOnNews, bool runOnModification, bool isActive, string situationOnApprove, string situationOnDisapprove, string parameterType, string parameterOption)
        {
            Name = name;
